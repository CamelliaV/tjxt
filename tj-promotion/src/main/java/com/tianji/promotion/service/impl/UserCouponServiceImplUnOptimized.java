...
//public class UserCouponServiceImplUnOptimized extends ServiceImpl<UserCouponMapper, UserCoupon> implements IUserCouponService {
...
/// /		}
//		// * 分布式锁
//		String key = PromotionConstants.COUPON_RECEIVE_REDIS_LOCK_PREFIX + userIdString;
/// /		boolean lock = redisLock.tryLock(key, 10, TimeUnit.SECONDS);
/// /		if (!lock) {
/// /			throw new BizIllegalException("领取优惠劵业务操作过于频繁");
/// /		}
/// /		try {
/// /			IUserCouponService userCouponService = (IUserCouponService) AopContext.currentProxy();
/// /			userCouponService.checkAndCreateUserCoupon(coupon);
